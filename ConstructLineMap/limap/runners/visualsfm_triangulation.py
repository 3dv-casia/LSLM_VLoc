...
def parse_config():
    ...
    arg_parser.add_argument('-c', '--config_file', type=str, default='/home/dell3660/limap/cfgs/triangulation/default.yaml', help='config file')
    arg_parser.add_argument('--default_config_file', type=str, default='/home/dell3660/limap/cfgs/triangulation/default.yaml', help='default config file')
